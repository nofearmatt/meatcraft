...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mobile menu functionality - возвращаемся к рабочей версии
    ...
    // Проверяем на дублирующиеся элементы - БЕЗОПАСНАЯ версия
    ...
    if (allMobileButtons.length > 1) {
        ...
        // Просто СКРЫВАЕМ дублирующиеся кнопки (не удаляем!)
